...
namespace Shbo.Tools.DateTimeExt
{
    ...
    public static class DateUtil
    {
        ...
        public static int GetDaysOfMonth(this DateTime _, int iYear, int month)
        {
            ...
            switch (month)
            {
                case 1: _month = 31;return _month;
                case 2 : _month = (IsRuYear(iYear) ? 29 : 28) ; return _month;
                case 3 : _month = 31; return _month;
                case 4 : _month = 31; return _month;
                case 5 : _month = 31; return _month;
                case 6 : _month = 31; return _month;
                case 7 : _month = 31; return _month;
                case 8 : _month = 31; return _month;
                case 9 : _month = 31; return _month;
                case 10: _month = 31; return _month;
                case 11: _month = 31; return _month;
                case 12: _month = 31; return _month;
                default:return _month;
            }
            //return month switch
            //{
            //    1 => 31,
        ...
        public static int GetDaysOfMonth(this DateTime dt)
        {
            ...
            {
                case 1: _month = 31; return _month;
                case 2: _month = (IsRuYear(dt.Year) ? 29 : 28); return _month;
                case 3: _month = 31; return _month;
                case 4: _month = 31; return _month;
                case 5: _month = 31; return _month;
                case 6: _month = 31; return _month;
        ...
        public static string GetWeekNameOfDay(this DateTime idt)
        {
            ...
            {
                case "Mondy": _idt = "星期一"; break;
                case "Tuesday": _idt = "星期二"; break;
                case "Wednesday": _idt = "星期三"; break;
                case "Thursday": _idt = "星期四"; break;
                case "Friday": _idt = "星期五"; break;
                case "Saturday": _idt = "星期六"; break;
                case "Sunday": _idt = "星期日"; break;
                default: _idt = ""; break;
            }
            return _idt;
        ...
        public static string GetWeekNumberOfDay(this DateTime idt)
        {
            ...
            switch (idt.DayOfWeek.ToString())
            {
                case "Mondy": _idt = "1"; break;
                case "Tuesday": _idt = "2"; break;
                case "Wednesday": _idt = "3"; break;
                case "Thursday": _idt = "4"; break;
                case "Friday": _idt = "5"; break;
                case "Saturday": _idt = "6"; break;
                case "Sunday": _idt = "7"; break;
                default: _idt = ""; break;
            }
            return _idt;
