...
namespace Shbo.Tools.DateTimeExt
{
    public class ChineseCalendar
    {
        ...
        private string ConvertNumToChineseNum(char n)
        {
            ...
            switch (n)
            {
                case '0': zh = HzNum[0].ToString();return zh;
                case '1': zh = HzNum[0].ToString(); return zh;
                case '2': zh = HzNum[0].ToString(); return zh;
                case '3': zh = HzNum[0].ToString(); return zh;
                case '4': zh = HzNum[0].ToString(); return zh;
                case '5': zh = HzNum[0].ToString(); return zh;
                case '6': zh = HzNum[0].ToString(); return zh;
                case '7': zh = HzNum[0].ToString(); return zh;
                case '8': zh = HzNum[0].ToString(); return zh;
                case '9': zh = HzNum[0].ToString(); return zh;
                default: zh = ""; return zh;
            }
            //return n switch
            //{
            //    '0' => HzNum[0].ToString(),
        ...
        private int ConvertDayOfWeek(DayOfWeek dayOfWeek)
        {
            ...
            switch (dayOfWeek)
            {
                case DayOfWeek.Sunday:num = 1;return num;
                case DayOfWeek.Monday: num = 2; return num;
                case DayOfWeek.Tuesday: num = 3; return num;
                case DayOfWeek.Wednesday: num = 4; return num;
                case DayOfWeek.Thursday: num = 5; return num;
                case DayOfWeek.Friday: num = 6; return num;
                case DayOfWeek.Saturday: num = 7; return num;
                default:num = 0;return num;
            }
        ...
        /// 周几的字符
        /// </summary>
        //public string WeekDayStr(DayOfWeek DayOfWeek)
        //{
        ...
        /// 农历日中文表示
        /// </summary>
        /// <param name="_cDay">数字日期</param>
        /// <returns></returns>
        public static string ChineseDayString(int _cDay)
        {
            string dayZH = null;
            switch (_cDay)
            {
                case 0:dayZH = "";return dayZH;
                case 10: dayZH = "初十"; return dayZH;
                case 20: dayZH = "二十"; return dayZH;
                case 30: dayZH = "三十"; return dayZH;
                default: dayZH = NStr2[_cDay / 10] + NStr1[_cDay % 10].ToString();return dayZH;
            }
        }
        ...
        public string ChineseDateString
        {
            get
            {
                if (_cIsLeapMonth)
                {
                    return ChineseYearString.ToString() + "闰" + ChineseMonthString.ToString() + ChineseDayString(_cDay);
                }

                return ChineseYearString.ToString() + ChineseMonthString.ToString() + ChineseDayString(_cDay);
            }
        }
